...
const Cart = () => {
  ...
  const { cartItems , remove } = useShoppingCart();
  const item = data.find((i) => i.id === cartItems[0]?.id)
  ...
  return (
    <div className='cart_container'>
      ...
      <div className="cart_body-info">
        {
        cartItems.length === 0 
        ? <div className="empty_msgbox">
        ...
        <>
          <div className="product-info">
            ...
            <button className="svg-container" onClick={() => {
              remove(item?.id)
            }}>
